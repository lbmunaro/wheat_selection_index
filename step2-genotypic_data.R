...
#2023
check_23 <- match.kinship2pheno(K=as.matrix(K_23), pheno.data=bluesG_23,
                                indiv = "germplasm", 
                                clean=F, mism=T)
check_23$mismatchesP # Indiv with pheno but not geno

#2022 & 2023
check_22.23 <- match.kinship2pheno(K=as.matrix(K_22.23), pheno.data=bluesG_22.23,
                                indiv = "germplasm", 
                                clean=F, mism=T)
check_22.23$mismatchesP # Indiv with pheno but not geno
