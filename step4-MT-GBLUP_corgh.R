...
# Objective ----
# - Run Multi-trait GBLUP for each scenario using corgh()
# - Get GEBVs
...
# https://juliengamartin.github.io/wam_tuto/asreml-biv.html
...
GEBVs_MT_GBLUP_22 <- update(GEBVs_MT_GBLUP_22)
...
mod_MT_GBLUP_23 <- asreml(fixed = predicted.value~trait,
                          ...
                          na.action = na.method(y='include', x='include'),
                          workspace = '32gb', maxit = 50)
GEBVs_MT_GBLUP_23 <- update(GEBVs_MT_GBLUP_23)
...
save.image('data/step4-MT-GBLUP_corgh.RData')
#load('data/step4-MT-GBLUP_corgh.RData')
